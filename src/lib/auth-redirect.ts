 ...
 * (`redirectTo`). Never hardcode localhost — GoTrue emails inherit Site
 * URL when this is omitted or not allowlisted.
 *
 * Supabase Dashboard → Authentication → URL Configuration:
 *   Site URL + Additional Redirect URLs must include
 *   `https://pulse-chi-nine.vercel.app/**`
 * plus local `http://localhost:5173/**` (Vite default; do not use a
 * global `https://*.vercel.app/**` wildcard).
 *
