...
-- Target only the 33 curated UUIDs. A city-wide UPDATE would rewrite OSM rows
-- inserted by 20260909180000_seattle_osm_venue_catalog.sql on `supabase db reset`.
UPDATE venues
SET pulse_score = 0,
    score_velocity = 0,
    last_activity = NULL,
